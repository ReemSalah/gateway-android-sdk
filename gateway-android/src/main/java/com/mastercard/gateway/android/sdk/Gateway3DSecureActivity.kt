...
class Gateway3DSecureActivity : AppCompatActivity() {

    internal lateinit var toolbar: Toolbar
    internal lateinit var webView: WebView

    internal val defaultTitle: String
        get() = getString(R.string.gateway_3d_secure_authentication)
    ...
    companion object {
         ...
         */
        const val EXTRA_TITLE = "com.mastercard.gateway.android.TITLE"
        ...
        internal const val REDIRECT_SCHEME = "gatewaysdk"
